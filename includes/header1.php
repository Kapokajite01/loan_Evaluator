...
<div id="templatemo_header_wrapper" style="max-width:100%;height:auto;">
    ...
    <?php
				...
				?>
					...
					<a style="color:#fff;text-shadow: 3px 2px green;"><?php echo "<strong>"."Welcome:". "&nbsp".$row['fname'];echo '&nbsp';echo $row['lname'];echo "&nbsp"."/"."&nbsp".$row['directorate']; ?></a>

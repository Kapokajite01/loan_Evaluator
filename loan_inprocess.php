...
<br><br>
<table class="blueTable" id ="example" align="center" style="width:75%">
<tr><td colspan="11"><h5 align="center"><strong><u>IN Process Applications <?php echo $reftime; ?></h5></u></td></tr>

<tr><th>No</th>
<th><strong>Applicant Names</strong></th>
...
while($rowsborowers= $resultborrowers->fetch_assoc()) {
	...
	?>
<tr><td><?php echo $i;?></td>
<td><?php echo $rowsborowers['first_name'];?>&nbsp;<?php echo $rowsborowers['last_name'];?></td>
<td><?php echo $rowsborowers['telephone'];?></td>
<td><?php echo $rowsborowers['district'];?>-<?php echo $rowsborowers['sector'];?>-<?php echo $rowsborowers['cell'];?>-<?php echo $rowsborowers['village'];?></td>
<td><?php echo $rowsborowers['loan_account'];?></td>
<td><?php echo $rowsborowers['loan_type'];?></td>
<td><?php 
if($rowsborowers['loan_status']=='')
{
	echo "Comercial Officer";
}
if($rowsborowers['loan_status']=='Sent To Credit Manager')
{
	echo "Credit Comittee Branch";
}
if($rowsborowers['loan_status']=='Sent To Branch Manager')
{
	echo "Credit Committee Head Office";
}

?></td>
<td><?php echo $rowsborowers['loan_interest'];?>%</td>
<td><?php echo $rowsborowers['loan_term_number'];?>&nbsp;<?php echo $rowsborowers['loan_term_type'];?>(s)</td>
<td><?php echo number_format($rowsborowers['loan_amount']);?></td>
<td><?php echo $rowsborowers['time_application'];?></td>
</tr>
  <?php $totalamount = $totalamount + $rowsborowers['loan_amount']; }?>
<?php }?> 
<tr><td colspan="9"><h5 align="right"><strong>Totals</h5></td><td colspan="2"><h5><strong><?php echo number_format($totalamount);?></h5></strong></td></tr>

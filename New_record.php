...
$(document).ready(function(){
  ...
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form action="account_search" method="POST">
	      <input type="text" name="branchname" id="branchname" value="<?php echo $branchname;?>" style="display:none" required>
...
<div class="form-group">
                ...
                <div class="input_container">
                    <input type="text" class="form-control" id="country_id" name="country_id" onkeyup="autocomplet()" autocomplete="off" required aria-required='true' aria-describedby='name-format' placeholder="Search Account Number">
                   &nbsp;&nbsp;&nbsp;&nbsp; <br><button type="submit" class="btn btn-primary" data-loading-text="Loading..." autocomplete="off">Search Account</button><br><br><ul id="country_list_id"></ul>
                </div></div><br><br>

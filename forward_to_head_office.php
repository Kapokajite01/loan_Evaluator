...
<form method="POST" ACTION="">
				<h1>	LOAN Forward  To Head Office Committee <img src="img/approval.jpg" alt="Smiley face" height="42" width="42"> </h1><hr>
				<table width="75%">
				...
				<tr><td></td><td><input type="submit" name="approve" value="Forward"></td><td><input type="submit" name="cancel" value="Cancel"></td></tr>
				</table>
				</form>
				</div>
</body>
...
if(isset($_POST['approve'])){
	$update = "UPDATE loan_details SET loan_status = 'Sent To Branch Manager' where loan_tracknumber = '$track'";
	...
	$_SESSION['redirect'] = 'yes';
		?>
		<script>
		alert('Loan Sent To Head Office Committee');
        </script>
		<script>

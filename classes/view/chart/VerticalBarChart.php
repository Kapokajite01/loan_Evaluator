...
error_reporting(0);
    ...
    class VerticalBarChart extends BarChart {
         ...
         */
        public function VerticalBarChart($width = 1200, $height = 600) {
            parent::BarChart($width, $height);

            $this->emptyToFullRatio = 0.5 / 5;
            $this->plot->setGraphPadding(new Padding(5, 80, 180, 200));
        }
        ...
        protected function printAxis() {
            ...
            for ($value = $minValue; $value <= $maxValue; $value += $stepValue) {
                ...
                imagerectangle($img, $graphArea->x1 - 1, $y, $graphArea->x1, $y + 3, $palette->axisColor[1]->getColor($img));

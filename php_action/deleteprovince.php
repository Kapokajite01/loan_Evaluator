...
$sql = "DELETE FROM province WHERE province_id='$provincename'";

if ($connect->query($sql) === TRUE) {?>

<div class="alert alert-success">
<?php	
    echo "<center>"."Province Deleted successfully"."</center>";
?>
</div>
<?php	
...
<?php
    echo "Province Delete failed." . $sql . "<br>" . $connect->error;
?>
</div>
<?php
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/where';\",1500);</script>";

...
session_start();
$_SESSION['cellname']  = addslashes($_POST['cellname']);
$cellname = $_SESSION['cellname'];

$_SESSION['sector_id']  = addslashes($_POST['sector_id']);
$sector_id = $_SESSION['sector_id'];

$sql = "INSERT INTO cells (cell_name, sector_id)
VALUES ('$cellname','$sector_id')";
...
<?php	
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/where';\",1500);</script>";
} else {?>

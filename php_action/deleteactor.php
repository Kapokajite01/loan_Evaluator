...
$deleteactorname = $_POST['deleteactorname'];


$sql = "DELETE FROM actors_in_groups WHERE actors_ingrou_id='$deleteactorname'";

if ($connect->query($sql) === TRUE) {?>

<div class="alert alert-success">
<?php	
    echo "<center>"."Institution Deleted successfully"."</center>";
?>
</div>
<?php	
...
<?php
    echo "Institution Delete failed." . $sql . "<br>" . $connect->error;
?>
</div>
<?php
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/who';\",1500);</script>";

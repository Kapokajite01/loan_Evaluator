...
$sql = "DELETE FROM district WHERE district_id='$districtname'";

if ($connect->query($sql) === TRUE) {?>

<div class="alert alert-success">
<?php	
    echo "<center>"."District Deleted successfully"."</center>";
?>
</div>
<?php	
...
<?php
    echo "District Delete failed." . $sql . "<br>" . $connect->error;
?>
</div>
<?php
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/where';\",1500);</script>";

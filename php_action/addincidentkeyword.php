...
session_start();
$_SESSION['keywordname']  = addslashes($_POST['keywordname']);
$keywordname = $_SESSION['keywordname'];

$_SESSION['incidentname']  = addslashes($_POST['incidentname']);
$incidentname = $_SESSION['incidentname'];

$sql = "INSERT INTO kewords (keyword_name, incident_id)
VALUES ('$keywordname','$incidentname')";

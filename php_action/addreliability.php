...
session_start();
$_SESSION['Add_reliability']  = addslashes($_POST['Add_reliability']);
$Add_reliability = $_SESSION['Add_reliability'];


$sql = "INSERT INTO institutions (institution_name)
VALUES ('$Add_reliability')";
...
<?php	
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/other';\",1500);</script>";
} else {?>

...
$actorgroup = $_POST['actorgroup'];


$sql = "DELETE FROM actors_group WHERE actors_grou_id='$actorgroup'";

if ($connect->query($sql) === TRUE) {?>

<div class="alert alert-success">
<?php	
    echo "<center>"."Actor Deleted successfully"."</center>";
?>
</div>
<?php	
...
<?php
    echo "Actor Delete failed." . $sql . "<br>" . $connect->error;
?>
</div>
<?php
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/who';\",1500);</script>";

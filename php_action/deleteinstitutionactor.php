...
$deleteinstitutionactor = $_POST['deleteinstitutionactor'];


$sql = "DELETE FROM members WHERE meber_id='$deleteinstitutionactor'";

if ($connect->query($sql) === TRUE) {?>

<div class="alert alert-success">
<?php	
    echo "<center>"."Institution member Deleted successfully"."</center>";
?>
</div>
<?php	
...
<?php
    echo "Institution member Delete failed." . $sql . "<br>" . $connect->error;
?>
</div>
<?php
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/who';\",1500);</script>";

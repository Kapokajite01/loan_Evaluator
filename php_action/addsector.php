...
session_start();
$_SESSION['sectorname']  = addslashes($_POST['sectorname']);
$sectorname = $_SESSION['sectorname'];

$_SESSION['districtname']  = addslashes($_POST['districtname']);
$districtname = $_SESSION['districtname'];

$sql = "INSERT INTO sector (sector_name, district_id)
VALUES ('$sectorname','$districtname')";

...
session_start();
$_SESSION['Actorgroupmember']  = addslashes($_POST['Actorgroupmember']);
$Actorgroupmember = $_SESSION['Actorgroupmember'];

$_SESSION['Actorgroup']  = addslashes($_POST['Actorgroup']);
$Actorgroup = $_SESSION['Actorgroup'];

$sql = "INSERT INTO actors_in_groups (actors_in_group_name, actors_group_id)
VALUES ('$Actorgroupmember','$Actorgroup')";

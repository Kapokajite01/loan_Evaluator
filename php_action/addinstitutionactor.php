...
session_start();
$_SESSION['ActorInstitution']  = addslashes($_POST['ActorInstitution']);
$ActorInstitution = $_SESSION['ActorInstitution'];

$_SESSION['institution']  = addslashes($_POST['institution']);
$institution = $_SESSION['institution'];

$sql = "INSERT INTO members (member_name, institution_id)
VALUES ('$ActorInstitution','$institution')";

...
$deletekeywordname = $_POST['deletekeywordname'];


$sql = "DELETE FROM kewords WHERE keyword_id='$deletekeywordname'";

if ($connect->query($sql) === TRUE) {?>

<div class="alert alert-success">
<?php	
    echo "<center>"."Key word Deleted successfully"."</center>";
?>
</div>
<?php	
...
<?php
    echo "Key word Delete failed." . $sql . "<br>" . $connect->error;
?>
</div>
<?php
	echo "<script>setTimeout(\"location.href = 'http://164.187.32.129/ims/what';\",1500);</script>";

...
<form method="POST" ACTION="">
				<h1>	LOAN Forward  To Credit Committee <img src="img/approval.jpg" alt="Smiley face" height="42" width="42"> </h1><hr>
				<table width="75%">
...
if(isset($_POST['approve'])){
	$update = "UPDATE loan_details SET loan_status = 'Sent To Credit Manager' where loan_tracknumber = '$track'";
	...
	$_SESSION['redirect'] = 'yes';
		?>
		<script>
		alert('Loan Sent To Credit Committee');
        </script>
		<script>

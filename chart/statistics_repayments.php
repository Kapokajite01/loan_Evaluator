...
//Select For January
  		$januarycl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-01-31' and last_payment >='$Y-01-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalcl= $totalcl + $pymtjanuarycl;
  ...
  if(!$totalcl){
	$totalcl=0;  
  		...
  		$januaryAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-01-31' and last_payment >='$Y-01-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalas= $totalas + $pymtjanuaryas;
  ...
  if(!$totalas){
	$totalas=0;  
  		...
  		$januaryIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-01-31' and last_payment >='$Y-01-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For February
  		$februarycl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-02-29' and last_payment >='$Y-02-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalfebruarycl= $totalfebruarycl + $pymtfebruarycl;
  ...
  if(!$totalfebruarycl){
	$totalfebruarycl=0;  
  		...
  		$februaryAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-02-29' and last_payment >='$Y-02-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalfebruaryas= $totalfebruaryas + $pymtfebruaryas;
  ...
  if(!$totalfebruaryas){
	$totalfebruaryas=0;  
  		...
  		$februaryIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-02-29' and last_payment >='$Y-02-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For March
  		$marchcl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-03-31' and last_payment >='$Y-03-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalmarchcl= $totalmarchcl + $pymtmarchcl;
  ...
  if(!$totalmarchcl){
	$totalmarchcl=0;  
  		...
  		$marchAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-03-31' and last_payment >='$Y-03-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalmarchas= $totalmarchas + $pymtmarchas;
  ...
  if(!$totalmarchas){
	$totalmarchas=0;  
  		...
  		$marchIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-03-31' and last_payment >='$Y-03-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For April
  		$aprilcl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-04-30' and last_payment >='$Y-04-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalaprilcl= $totalaprilcl + $pymtaprilcl;
  ...
  if(!$totalaprilcl){
	$totalaprilcl=0;  
  		...
  		$aprilAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-04-30' and last_payment >='$Y-04-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalaprilas= $totalaprilas + $pymtaprilas;
  ...
  if(!$totalaprilas){
	$totalaprilas=0;  
  		...
  		$aprilIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-04-30' and last_payment >='$Y-04-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For May
  		$maycl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-05-31' and last_payment >='$Y-05-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalmaycl= $totalmaycl + $pymtmaycl;
  ...
  if(!$totalmaycl){
	$totalmaycl=0;  
  		...
  		$mayAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-05-31' and last_payment >='$Y-05-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalmayas= $totalmayas + $pymtmayas;
  ...
  if(!$totalmayas){
	$totalmayas=0;  
  		...
  		$mayIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-05-31' and last_payment >='$Y-05-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For JUNE
$junecl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-06-30' and last_payment >='$Y-06-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaljunecl= $totaljunecl + $pymtjunecl;
  ...
  if(!$totaljunecl){
	$totaljunecl=0;  
  		...
  		$juneAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-06-30' and last_payment >='$Y-06-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaljuneas= $totaljuneas + $pymtjuneas;
  ...
  if(!$totaljuneas){
	$totaljuneas=0;  
  		...
  		$juneIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-06-30' and last_payment >='$Y-06-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For JULY
$julycl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-07-31' and last_payment >='$Y-07-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaljulycl= $totaljulycl + $pymtjulycl;
  ...
  if(!$totaljulycl){
	$totaljulycl=0;  
  		...
  		$julyAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-07-31' and last_payment >='$Y-07-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaljulyas= $totaljulyas + $pymtjulyas;
  ...
  if(!$totaljulyas){
	$totaljulyas=0;  
  		...
  		$julyIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-07-31' and last_payment >='$Y-07-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For AUGUST
$augustcl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-08-31' and last_payment >='$Y-08-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalaugustcl= $totalaugustcl + $pymtaugustcl;
  ...
  if(!$totalaugustcl){
	$totalaugustcl=0;  
  		...
  		$augustAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-08-31' and last_payment >='$Y-08-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalaugustas= $totalaugustas + $pymtaugustas;
  ...
  if(!$totalaugustas){
	$totalaugustas=0;  
  		...
  		$augustIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-08-31' and last_payment >='$Y-08-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$septembercl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-09-30' and last_payment >='$Y-09-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalseptembercl= $totalseptembercl + $pymtseptembercl;
  ...
  if(!$totalseptembercl){
	$totalseptembercl=0;  
  		...
  		$septemberAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-09-30' and last_payment >='$Y-09-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalseptemberas= $totalseptemberas + $pymtseptemberas;
  ...
  if(!$totalseptemberas){
	$totalseptemberas=0;  
  		...
  		$septemberIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-09-30' and last_payment >='$Y-09-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For October
$octobercl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-10-31' and last_payment >='$Y-10-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaloctobercl= $totaloctobercl + $pymtoctobercl;
  ...
  if(!$totaloctobercl){
	$totaloctobercl=0;  
  		...
  		$octoberAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-10-31' and last_payment >='$Y-10-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaloctoberas= $totaloctoberas + $pymtoctoberas;
  ...
  if(!$totaloctoberas){
	$totaloctoberas=0;  
  		...
  		$octoberIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-10-31' and last_payment >='$Y-10-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For November
$novembercl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-11-30' and last_payment >='$Y-11-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalnovembercl= $totalnovembercl + $pymtnovembercl;
  ...
  if(!$totalnovembercl){
	$totalnovembercl=0;  
  		...
  		$novemberAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-11-30' and last_payment >='$Y-11-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totalnovemberas= $totalnovemberas + $pymtnovemberas;
  ...
  if(!$totalnovemberas){
	$totalnovemberas=0;  
  		...
  		$novemberIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-11-30' and last_payment >='$Y-11-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Select For December
$decembercl = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Commercial Loan') AND (first_payment <= '$Y-12-31' and last_payment >='$Y-12-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaldecembercl= $totaldecembercl + $pymtdecembercl;
  ...
  if(!$totaldecembercl){
	$totaldecembercl=0;  
  		...
  		$decemberAS = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Advance Salary') AND (first_payment <= '$Y-12-31' and last_payment >='$Y-12-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totaldecemberas= $totaldecemberas + $pymtdecemberas;
  ...
  if(!$totaldecemberas){
	$totaldecemberas=0;  
  		...
  		$decemberIG = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (loan_type = 'Investment Group') AND (first_payment <= '$Y-12-31' and last_payment >='$Y-12-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Sum for January
  		...
  		$january = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-01-31' and last_payment >='$Y-01-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totamontlypaymetjanuary = $totamontlypaymetjanuary + $pymtjanuary;
 ...
 //Sum for February
$february = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-02-29' and last_payment >='$Y-02-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totamontlypaymetfebruary = $totamontlypaymetfebruary + $pymtfebruary;
 ...
 //Sum for March
$march = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-03-31' and last_payment >='$Y-03-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totamontlypaymetmarch = $totamontlypaymetmarch + $pymtmarch;
 ...
 //Sum for April
$april = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-04-30' and last_payment >='$Y-04-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
//Sum for May
$may = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-05-31' and last_payment >='$Y-05-01')  AND (loan_status ='Approved') ORDER  BY first_payment ";
...
$totamontlypaymetpymtmay = $totamontlypaymetpymtmay + $pymtmay;
 ...
 //Sum for June
$june = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-06-30' and last_payment >='$Y-06-01')  AND (loan_status ='Approved') ORDER  BY first_payment";
...
$totamontlypaymetpymtjune = $totamontlypaymetpymtjune + $pymtjune;
 ...
 //Sum for July
$july = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-07-31' and last_payment >='$Y-07-01')  AND (loan_status ='Approved') ORDER  BY first_payment";
...
$totamontlypaymetpymtjuly = $totamontlypaymetpymtjuly + $pymtjuly;
 ...
 //Sum for August
$august = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-08-31' and last_payment >='$Y-08-01')  AND (loan_status ='Approved') ORDER  BY first_payment";
...
$totamontlypaymetpymtaugust = $totamontlypaymetpymtaugust + $pymtaugust;
 ...
 //Sum for Septemeber
$september = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-09-30' and last_payment >='$Y-09-01')  AND (loan_status ='Approved') ORDER  BY first_payment";
...
$totamontlypaymetpymtseptt = $totamontlypaymetpymtseptt + $pymtsept;
 ...
 //Sum  for October
$october = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-10-31' and last_payment >='$Y-10-01')  AND (loan_status ='Approved') ORDER  BY first_payment";
...
$totamontlypaymetpymtoct = $totamontlypaymetpymtoct + $pymtoct;
 ...
 //Sum for November
$november = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-11-30' and last_payment >='$Y-11-01')  AND (loan_status ='Approved') ORDER  BY first_payment";
...
$totamontlypaymetpymtnov = $totamontlypaymetpymtnov + $pymtnov;
   ...
   //Sum for December
$december = "SELECT loan_tracknumber,loan_account,loan_term_type,loan_term_number,loan_interest,first_payment,last_payment,loan_type,loan_amount FROM  loan_details where (first_payment <= '$Y-12-31' and last_payment >='$Y-12-01')  AND (loan_status ='Approved') ORDER  BY first_payment";

...
while($rowsborowers= $resultborrowers->fetch_assoc()) {
	$i++;
	$typeloan = $rowsborowers['loan_type'];
...
?></td>
<td><a href="product_details?loantype=<?php  echo $typeloan;?>">Details</a></td>
...
<tr><td colspan="2" ><h5 align="right"><strong>Totals</td><td><?php echo $totnumloans;?></td><td><h5><strong><?php echo number_format($totalamount);?></h5></strong></td><td colspan="2" align="right"><h5><strong><?php echo number_format($totamontlypaymet);?></h5></strong></td></tr>
<?php }?> 
</table></form><hr>

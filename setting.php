	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				 ...
				 <a class="btn btn-danger"href="add_user.php"> <i  class="glyphicon glyphicon-plus"></i> Add users </a>
                 <a class="btn btn-success" <i  class="glyphicon glyphicon-plus"></i> Users </a>

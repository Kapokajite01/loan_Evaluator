...
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Loan Amount :&nbsp;&nbsp;</i><span id="loanmountlabel"><?php echo  number_format($loan_amount);?></strong></span><input type="text" name="changeamount" id="changeamount"  style=" width:100px; height: 25px;display:none;" value="<?php echo $loan_amount;?>"  onkeyup="summed1();"> <?php if ($role=='Branch Manager'){echo '<input type="checkbox" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck"><i> <strong><font color="yellow">Edit</font></strong></i>';}?></td><tr>
...
</table><input type="submit" name="editloan"  value="Edit"></form><br>

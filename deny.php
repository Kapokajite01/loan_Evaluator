...
<form method="POST" ACTION="">
				<h1>	LOAN Dropping  <img src="img/delattach.png.png" alt="Smiley face" height="42" width="42"> </h1><hr>
				<table width="75%">
				...
				<tr><td></td><td><input type="submit" name="deny" value="Deny"></td><td><input type="submit" name="cancel" value="Cancel"></td></tr>
				</table>
				</form>
				</div>
</body>
<?PHP
if(isset($_POST['deny'])){
	$update = "UPDATE loan_details SET loan_status = 'Deny' where loan_tracknumber = '$track'";

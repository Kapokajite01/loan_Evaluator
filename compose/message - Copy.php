...
$_SESSION['mysender']=$sender;
$mysender = $_SESSION['mysender'];
...
$(function() {
    ...
    .autocomplete({
        ...
        source: function( request, response ) {
            ...
            $.getJSON("http://localhost/sintras/modul/compose/skills.php?sen=<?php echo $mysender;?>", { term : extractLast( request.term )},response);
        },
...
$(function() {
    ...
    $( "#bccc" ).bind( "keydown", function( event ) {
        if ( event.keyCode === $.ui.keyCode.TAB &&
            $( this ).autocomplete( "instance" ).menu.active ) {
            event.preventDefault();
        }

...
session_start();
error_reporting(0);
$conn = mysqli_connect("localhost", "root", "fidele", "phpsamples");
$incident1  = "Select Incident One";
$incident2  = "Select Incident Two";
...
$insNYAGATAREs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYAGATARE','$numcoutsNYAGATARE,','$numcoutsNYAGATARE1,')";
...
$insBURERAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameBURERA','$numcoutsBURERA,','$numcoutsBURERA1,')";
...
$insMUSANZEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameMUSANZE','$numcoutsMUSANZE,','$numcoutsMUSANZE1,')";
...
$insGICUMBIs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameGICUMBI','$numcoutsGICUMBI,','$numcoutsGICUMBI1,')";
...
$insGATSIBOs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameGATSIBO','$numcoutsGATSIBO,','$numcoutsGATSIBO1,')";
...
$insRULINDOs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameRULINDO','$numcoutsRULINDO,','$numcoutsRULINDO1,')";
...
$insGAKENKEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameGAKENKE','$numcoutsGAKENKE,','$numcoutsGAKENKE1,')";
...
$insNYABIHUs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYABIHU','$numcoutsNYABIHU,','$numcoutsNYABIHU1,')";
...
$insRUBAVUs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameRUBAVU','$numcoutsRUBAVU,','$numcoutsRUBAVU1,')";
...
$insKAYONZAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameKAYONZA','$numcoutsKAYONZA,','$numcoutsKAYONZA1,')";
...
$insRWAMAGANAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameRWAMAGANA','$numcoutsRWAMAGANA,','$numcoutsRWAMAGANA1,')";
...
$insGASABOs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameGASABO','$numcoutsGASABO,','$numcoutsGASABO1,')";
...
$insNGOROREROs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNGORORERO','$numcoutsNGORORERO,','$numcoutsNGORORERO1,')";
...
$insRUTSIROs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameRUTSIRO','$numcoutsRUTSIRO,','$numcoutsRUTSIRO1,')";
...
$insKICUKIROs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameKICUKIRO','$numcoutsKICUKIRO,','$numcoutsKICUKIRO1,')";
...
$insNYARUGENGEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYARUGENGE','$numcoutsNYARUGENGE,','$numcoutsNYARUGENGE1,')";
...
$insKAMONYIs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameKAMONYI','$numcoutsKAMONYI,','$numcoutsKAMONYI1,')";
...
$insMUHANGAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameMUHANGA','$numcoutsMUHANGA,','$numcoutsMUHANGA1,')";
...
$insKARONGIs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameKARONGI','$numcoutsKARONGI,','$numcoutsKARONGI1,')";
...
$insKIREHEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameKIREHE','$numcoutsKIREHE,','$numcoutsKIREHE1,')";
...
$insNGOMAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNGOMA','$numcoutsNGOMA,','$numcoutsNGOMA1,')";
...
$insBUGESERAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameBUGESERA','$numcoutsBUGESERA,','$numcoutsBUGESERA1,')";
...
$insRUHANGOs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameRUHANGO','$numcoutsRUHANGO,','$numcoutsRUHANGO1,')";
...
$insNYANZAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYANZA','$numcoutsNYANZA,','$numcoutsNYANZA1,')";
...
$insGISAGARAs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameGISAGARA','$numcoutsGISAGARA,','$numcoutsGISAGARA1,')";
...
$insNYAMASHEKEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYAMASHEKE','$numcoutsNYAMASHEKE,','$numcoutsNYAMASHEKE1,')";
...
$insNYAMAGABEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYAMAGABE','$numcoutsNYAMAGABE,','$numcoutsNYAMAGABE1,')";
...
$insRUSIZIs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameRUSIZI','$numcoutsRUSIZI,','$numcoutsRUSIZI1,')";
...
$insHUYEs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameHUYE','$numcoutsHUYE,','$numcoutsHUYE1,')";
...
$insNYARUGURUs = "insert into chart(district_name,fist_value,second_value)VALUES ('$distrnameNYARUGURU','$numcoutsNYARUGURU','$numcoutsNYARUGURU1')";

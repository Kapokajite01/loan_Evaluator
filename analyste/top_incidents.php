...
count(incident_name) FROM reports WHERE (MONTH(dateincident)= MONTH(CURDATE())and YEAR(dateincident)= YEAR(CURDATE()))  GROUP BY  incident_name";
if ($conn->multi_query($sql) === TRUE) {
...
mysqli_close($conn);
    ...
    var chart = new CanvasJS.Chart("chartContainer", {
    	...
    	theme: "light2",
    	title:{
    		text: "Top Five Incidents In This Month"
    	},
    	legend:{
    		cursor: "pointer",

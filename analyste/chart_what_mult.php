...
<form action="chart_what_mult" method="POST">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<select name="incident1" style="max-width:100%;"><option value="">1<sup>st</sup> Incident</option>
<?php 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<select name="incident2" style="max-width:100%;"><option value="">2<sup>nd</sup> Incident</option>
<?php 
while ($row = mysql_fetch_array($result))
{
    echo "<option value='".$row['incident_name']."'>".$row['incident_name']."</option>";
...
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"><button class="btn btn-default button1"> <B>
...
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a url="/ims/analyste/who"><button class="btn btn-default button1"> <B>
...
$sql = "INSERT INTO chart(id,total_incidents) values('',0)";
...
$incident1=$_REQUEST['incident1'];
$incident2=$_REQUEST['incident2'];
$startdate=$_REQUEST['startdate'];
$enddate=$_REQUEST['enddate'];



if($incident1!="" AND $incident2!="" AND $startdate=="" AND $enddate==""){
$sql = "INSERT INTO chart (district_name, keywords,keywords2,keywords3,label, total_incidents) 
SELECT district_name, incident_name, actor_name,dateincident,CONCAT(district_name,'-',neighbor_country,'-',incident_name),
count(incident_name) FROM reports WHERE (incident_name='$incident1' OR incident_name='$incident2') 
GROUP BY district_name,neighbor_country";
	}


elseif($incident1!="" AND $incident2!="" AND $startdate!="" AND $enddate!=""){
$sql = "INSERT INTO chart (district_name, keywords, keywords2,keywords3, label, total_incidents) 
SELECT district_name, incident_name, actor_name,dateincident, CONCAT(district_name,neighbor_country,incident_name),
count(incident_name) FROM reports WHERE (incident_name='$incident1' OR incident_name='$incident2') AND 
(dateincident BETWEEN '$startdate' AND '$enddate') GROUP BY district_name";
...
SELECT district_name, incident_name, actor_name,dateincident,CONCAT(district_name,neighbor_country),
count(incident_name) FROM reports WHERE (incident_name='$incident1' OR incident_name='$incident2') 
...
SELECT district_name, incident_name, actor_name,dateincident, CONCAT(district_name,neighbor_country),
count(incident_name) FROM reports WHERE (incident_name='$incident1' OR incident_name='$incident2') AND 
(dateincident BETWEEN '$startdate' AND '$enddate') 
GROUP BY district_name,neighbor_country, actor_name, incident_name,dateincident";
...
<body>
	...
	<table class="data-table">
		...
		{
			echo '<tr>
			<td>District:&nbsp;&nbsp;'.$row['label'].'
			<br>Actor:&nbsp;&nbsp;'.$row['keywords2'].'<br>Incident:&nbsp;&nbsp;'.$row['keywords'].

...
<div id="templatemo_menu_wrapper">
    ...
    <div id="templatemo_menu">
        ...
        <ul>
				            <li><a href="multi_variation" class="current"><span class="invo">Dashboard</span></a></li>
...
$query = "SELECT DISTINCT incident_name FROM reports ORDER BY incident_name ASC";

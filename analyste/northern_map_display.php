...
$conn = mysqli_connect("localhost", "root", "fidele", "mudb_ims_db");
	$result = '';
	$query1 = "SELECT total_incidents FROM map WHERE district_name ='BURERA' OR district_name ='GAKENKE' OR district_name ='GICUMBI' OR district_name ='MUSANZE' OR district_name ='RULINDO'";
	$W;
	$mynum =0;
...
$num = count($f);
?>
<body style="background-color: #ffffff ; background-image:url(images/mapdisplay_northern.png); background-repeat: no-repeat;background-position:center;">
...
echo '<font color="black"><strong>'.$f[1];
					}else{
						echo '<img src="images/elsepin.png"></img>';
					}
					?></span></div>	

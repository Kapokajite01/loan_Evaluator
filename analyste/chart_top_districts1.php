...
$sqlQuery = "SELECT id,district_name,keywords,keywords2,keywords3,district_code,label,total_incidents FROM chart where (label != 'BURUNDI') AND (label != 'DRC')AND (label != 'TANZANIA')AND (label != 'UGANDA')   order by total_incidents DESC LIMIT 10";
...
mysqli_close($conn);
    ...
    $dataPoints1 = array(
    	...
    	array("label"=> $distr[5], "y"=>  $total[5]),
    	array("label"=> $distr[6], "y"=>  $total[6]),
    	array("label"=> $distr[7], "y"=>  $total[7]),
    	array("label"=> $distr[8], "y"=>  $total[8]),   	array("label"=> $distr[0], "y"=>  $total[0]),
    	array("label"=> $distr[1], "y"=>  $total[1]),
    	array("label"=> $distr[2], "y"=>  $total[2]),
    	array("label"=> $distr[3], "y"=>  $total[3]),
    	array("label"=> $distr[4], "y"=>  $total[4]),
    	...
    	array("label"=> $distr[6], "y"=>  $total[6]),
    	array("label"=> $distr[7], "y"=>  $total[7]),
    	array("label"=> $distr[8], "y"=>  $total[8]),
    	array("label"=> $distr[9], "y"=>  $total[9])
    );
    ...
    <body>
    <div id="chartContainer" style="height: 370px; width: 300%;"></div>

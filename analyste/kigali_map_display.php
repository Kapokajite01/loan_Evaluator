...
$conn = mysqli_connect("localhost", "root", "fidele", "mudb_ims_db");
	$result = '';
	$query1 = "SELECT total_incidents FROM map WHERE district_name ='GASABO' OR district_name ='KICUKIRO' OR district_name ='NYARUGENGE'";
	$W;
	$mynum =0;
...
$num = count($f);
?>
<body style="background-color: #ffffff ; background-image:url(images/mapdisplay_kigali.png); background-repeat: no-repeat;background-position:center;">
...
echo '<img src="images/mappinpeople.png"></img>';
						echo '<font color="black"><strong>'.$f[11];

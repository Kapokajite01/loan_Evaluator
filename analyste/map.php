...
?>
<form action="map_action" method="POST">
<div id="submitForm">
...
?>        
			 ...
			 From:<input type="date" name="startdate" id="datesearch" value="" required>
			 To:<input type="date" name="enddate" id="datesearch" value="" required>

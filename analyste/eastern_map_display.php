...
$conn = mysqli_connect("localhost", "root", "fidele", "mudb_ims_db");
	$result = '';
	$query1 = "SELECT total_incidents FROM map WHERE district_name ='BUGESERA' OR district_name ='GATSIBO' OR district_name ='KAYONZA' OR district_name ='KIREHE' OR district_name ='NGOMA' OR district_name ='NYAGATARE' OR district_name ='RWAMAGANA'";
	$W;
	$mynum =0;
...
$num = count($f);
?>
<body style="background-color: #ffffff ; background-image:url(images/mapdisplay_eastern.png); background-repeat: no-repeat;background-position:center;">

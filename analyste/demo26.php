...
if($members>0){
$sql="select  report_id,institution_name,member_name,subject,classification_name,dateincident,noattachments,Status from reports where memebers =$members order by report_id DESC";
}else{
...
//////////////
@$main = array('data'=>$result,'value'=>array("members"=>"$members","message"=>"$message"));

...
// Create connection
$conn01 = new mysqli($servername, $username, $password, $dbname);
// Check connection
if ($conn01->connect_error) {
    die("Connection failed: " . $conn01->connect_error);
} 


$sql0 = "TRUNCATE TABLE chart";


if ($conn0->multi_query($sql0) === TRUE) {
    //echo "Delete";
} else {
    echo "Error: " . $sql0 . "<br>" . $conn0->error;
}
...
*/
$MYTIME = "INCIDENTS BY DISTRICTS IN".date(' F Y ');


$sql01 = "INSERT INTO chart (district_name, keywords,keywords2,keywords3,district_code, label, total_incidents) 
SELECT district_name, incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),count(incident_name) 
FROM reports WHERE  MONTH(dateincident)= MONTH(CURDATE())and YEAR(dateincident)= YEAR(CURDATE()) AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' GROUP BY district_name";
...
if ($conn0->multi_query($sql0) === TRUE) {
	...
	if ($conn01->multi_query($sql01) === TRUE) {
    //echo "New records created successfully";
} else {
    echo "Error: " . $sql01 . "<br>" . $conn01->error;
}
...
<form action="chart_what" method="POST">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="incident" style="max-width:100%;" required><option value="">Select Incident</option>
...
<font color="black">Period</B></font></button></a>
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chart_where"><button class="btn btn-default button1"> <B>
<font color="black">Locations</B></font></button></a>
<br>
<br>
...
// Create connection
$connk = new mysqli($servername, $username, $password, $dbname);
// Check connection
if ($connk->connect_error) {
    die("Connection failed: " . $connk->connect_error);
}

// Create connection
$connkK = new mysqli($servername, $username, $password, $dbname);
// Check connection
if ($connkK->connect_error) {
    die("Connection failed: " . $connkK->connect_error);
}


// Create connection
$connkKK = new mysqli($servername, $username, $password, $dbname);
// Check connection
if ($connkKK->connect_error) {
    die("Connection failed: " . $connkKK->connect_error);
}


// Create connection
$connkKKK = new mysqli($servername, $username, $password, $dbname);
// Check connection
if ($connkKKK->connect_error) {
    die("Connection failed: " . $connkKKK->connect_error);
}
...
if($incident=="All" AND $startdate!="" AND $enddate!=""){
	
$sql = "INSERT INTO chart (district_name,Province_name,keywords, keywords2,keywords3,district_code,label, total_incidents) 
SELECT district_name,povince_name,incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),
count(incident_name) AS ninci FROM reports WHERE ((dateincident BETWEEN '$startdate' AND '$enddate')AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' AND povince_name = 'City of Kigali' AND incident != 53 AND incident != 33) GROUP BY district_name,neighbor_country ORDER BY ninci DESC ";


$sqlk = "INSERT INTO chart (district_name,Province_name,keywords, keywords2,keywords3,district_code,label, total_incidents) 
SELECT district_name,povince_name,incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),
count(incident_name) AS ninci FROM reports WHERE ((dateincident BETWEEN '$startdate' AND '$enddate')AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' AND povince_name = 'Northern Province' AND incident != 53 AND incident != 33 ) GROUP BY district_name,neighbor_country  ORDER BY ninci DESC ";

$sqlkK = "INSERT INTO chart (district_name,Province_name,keywords, keywords2,keywords3,district_code,label, total_incidents) 
SELECT district_name,povince_name,incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),
count(incident_name) AS ninci FROM reports WHERE ((dateincident BETWEEN '$startdate' AND '$enddate')AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' AND povince_name = 'Southern Province' AND incident != 53 AND incident != 33) GROUP BY district_name,neighbor_country  ORDER BY ninci DESC ";


$sqlkKK = "INSERT INTO chart (district_name,Province_name,keywords, keywords2,keywords3,district_code,label, total_incidents) 
SELECT district_name,povince_name,incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),
count(incident_name) AS ninci FROM reports WHERE ((dateincident BETWEEN '$startdate' AND '$enddate')AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' AND povince_name = 'Eastern Province' AND incident != 53 AND incident != 33  ) GROUP BY district_name,neighbor_country  ORDER BY ninci DESC ";


$sqlkKKK = "INSERT INTO chart (district_name,Province_name,keywords, keywords2,keywords3,district_code,label, total_incidents) 
SELECT district_name,povince_name,incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),
count(incident_name) AS ninci FROM reports WHERE ((dateincident BETWEEN '$startdate' AND '$enddate')AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' AND povince_name = 'Western Province' AND incident != 53 AND incident != 33) GROUP BY district_name,neighbor_country  ORDER BY ninci DESC ";

$MYTIME = "ALL INCIDENTS FROM ".$newDate." TO ". $newDate1."";
		
}


elseif($incident!="" AND $startdate!="" AND $enddate!=""){
$sql = "INSERT INTO chart (district_name, keywords, keywords2,keywords3,district_code,label, total_incidents) 
SELECT district_name, incident_name, actor_name,dateincident,district,CONCAT(district_name,neighbor_country),
count(incident_name) FROM reports WHERE incident_name='$incident' AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC'  
AND (dateincident BETWEEN '$startdate' AND '$enddate') GROUP BY district_name,neighbor_country,incident_name";
$MYTIME = $incident. " FROM ".$newDate." TO ". $newDate1."";
...
if ($connk->multi_query($sqlk) === TRUE) {
    //echo "New records created successfully";
} 
if ($connkK->multi_query($sqlkK) === TRUE) {
    //echo "New records created successfully";
}

if ($connkKK->multi_query($sqlkKK) === TRUE) {
    //echo "New records created successfully";
} 
	
if ($connkKKK->multi_query($sqlkKKK) === TRUE) {
    //echo "New records created successfully";
} 
$conn->close();
$connk->close();
...
mysql_connect("localhost", "root","fidele") or die(mysql_error());
mysql_select_db("mudb_ims_db") or die(mysql_error());
$query = "SELECT * FROM chart WHERE label!='BURUNDI'AND label!='DRC' AND label!='TANZANIA' AND  label!='UGANDA' ORDER BY id,total_incidents DESC";
$result = mysql_query($query) or die(mysql_error()."[".$query."]");
while ($row = mysql_fetch_array($result))
{
...
<head>
 ...
 <?php 
			$query = "SELECT * FROM chart ORDER BY id";
			 ...
			 echo "['".$row['label']."',".$row['total_incidents']."],";
			 }
			 ?> 
...
$sqlinsert = "INSERT INTO details (district_name, keywords, keywords2,keywords3, label, total_incidents) 
SELECT district_name, incident_name, actor_name,dateincident,CONCAT(district_name,neighbor_country), count(incident_name) FROM reports WHERE  MONTH(dateincident)= MONTH(CURDATE())and YEAR(dateincident)= YEAR(CURDATE())GROUP BY district_name,neighbor_country, actor_name, incident_name,dateincident";
$conn->close();
?>
...
SELECT district_name, incident_name, actor_name,dateincident,CONCAT(district_name,neighbor_country), count(incident_name) FROM reports WHERE incident_name='$incident' 
AND (dateincident BETWEEN '$startdate' AND '$enddate') 
GROUP BY district_name,neighbor_country, actor_name, incident_name,dateincident";
		
}
if($incident=="All" AND $startdate!="" AND $enddate!=""){
$sql = "INSERT INTO details (district_name, keywords, keywords2,keywords3, label, total_incidents) 
SELECT district_name, incident_name, actor_name,dateincident,CONCAT(district_name,neighbor_country), count(incident_name) FROM reports WHERE dateincident BETWEEN '$startdate' AND '$enddate'  AND incident != 53 AND incident != 33 
GROUP BY district_name,neighbor_country, actor_name, incident_name,dateincident";
...
$sql = 'SELECT * 
		FROM details WHERE total_incidents!=0 ORDER BY label,keywords3 ';
...
table td.expand {
	...
	<table class="data-table">
		...
		{
			echo '<tr>
			<td>Location:&nbsp;&nbsp;'.$row['label'].'<br>ACTOR:&nbsp;&nbsp;'.$row['keywords2'].

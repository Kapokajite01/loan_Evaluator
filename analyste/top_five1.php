...
<form action="top_five1" method="POST">
...
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="top_five"><button class="btn btn-default button1"> <B>
<font color="black">Top Five</B></font></button></a>
<br>
<br>
...
$sql = "INSERT INTO chart(id,district_name,keywords,keywords2,keywords3,total_incidents) values('','','','','$incident',0)";
...
FROM reports WHERE incident_name='$incident' AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' GROUP BY district_name,neighbor_country,incident_name";
...
count(incident_name) FROM reports WHERE ((dateincident BETWEEN '$startdate' AND '$enddate')AND district_name !='BURUNDI' AND district_name !='TANZANIA' AND district_name !='UGANDA' AND district_name !='DRC' ) GROUP BY district_name,neighbor_country";
...
$sqlQuery = "SELECT id,district_name,keywords,keywords2,keywords3,district_code,label,total_incidents FROM chart where (label != 'BURUNDI') AND (label != 'DRC')AND (label != 'TANZANIA')AND (label != 'UGANDA')   order by total_incidents DESC LIMIT 5";
...
mysqli_close($conn);
    ...
    $dataPoints1 = array(
    	array("label"=> $distr[0], "y"=>  $total[0]),
    	array("label"=> $distr[1], "y"=>  $total[1]),
    	array("label"=> $distr[2], "y"=>  $total[2]),
    	array("label"=> $distr[3], "y"=>  $total[3]),
    	array("label"=> $distr[4], "y"=>  $total[4])
    );
    
    $a = "Top Five Incidents In This Month";	
    ?>
    <!DOCTYPE HTML>
    <html>
    <head>  
    ...
    var chart = new CanvasJS.Chart("chartContainer", {
    	...
    	theme: "light2",
    	title:{
    		text: "Top Five Incidents From <?php  echo $newDate;?> To <?php  echo $newDate1;?> "
    	},
    	legend:{
    		cursor: "pointer",

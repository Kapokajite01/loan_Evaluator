...
if(!is_numeric($cat_id3)){
$message.="Data Error |";
exit;
}

if($cat_id3>0){
$sql="select report_id,povince_name, district_name,sector_name,cell_name,subject,classification_name,dateincident,noattachments,Status from reports WHERE cell = '$cat_id3'order by report_id DESC";
}else{
...
//////////////
@$main = array('data'=>$result,'value'=>array("cat_id3"=>"$cat_id3","message"=>"$message"));

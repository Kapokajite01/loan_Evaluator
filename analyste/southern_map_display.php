...
$conn = mysqli_connect("localhost", "root", "fidele", "mudb_ims_db");
	$result = '';
	$query1 = "SELECT total_incidents FROM map WHERE district_name ='GISAGARA' OR district_name ='HUYE' OR district_name ='KAMONYI' OR district_name ='MUHANGA' OR district_name ='NYAMAGABE' OR district_name ='NYANZA' OR district_name ='NYARUGURU' OR district_name ='RUHANGO'";
	$W;
	$mynum =0;
...
$num = count($f);
?>
<body style="background-color: #ffffff ; background-image:url(images/mapdisplay_southern.png); background-repeat: no-repeat;background-position:center;">
...
echo '<img src="images/mappinpeople.png"></img>';
						echo '<font color="black"><strong>'.$f[16];

...
$neighbor_country = $_POST['neighberscountries'];
$neighbor_province = $_POST['neigborprovince'];
$neighbor_district = $_POST['neighberdistrict'];
$occcurency = $_POST['occurence'];
...
$largestlevel = $largestlevel+1;
    ...
    foreach ($_FILES as $name => $file) {
        if (!$file['name'] == "") {
            ...
            $server_file = dirname(__FILE__) . "/../analyste/files/" . $path_part['basename'];

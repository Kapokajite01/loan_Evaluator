...
<font color="maroon">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>STATISTICS ON <BR>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MULTIPLE-INCIDENT</b><br><br></font></b>

	
<form method="POST" action="chart_action.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="incident1" style="max-width:100%;display: block;margin-left: auto;margin-right: auto;"><option value="">Select Incident1</option>
<?php 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="incident2" style="max-width:100%;display: block;margin-left: auto;margin-right: auto;"><option value="">Select Incident2</option>
<?php 
while ($row = mysql_fetch_array($result))
{
    echo "<option value='".$row['incident_name']."'>".$row['incident_name']."</option>";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From:<input type="date" name="startdate" value="" id="datesearch" placeholder="From" aria-describedby='name-format' style="display: block;margin-left: auto;margin-right: auto;"> 
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To:<input type="date" name="enddate" value="" id="datesearch" placeholder="To" aria-describedby='name-format' style="display: block;margin-left: auto;margin-right: auto;"> 

<br><BR><BR><input type="submit" name="submit" style="display: block;margin-left: auto;margin-right: auto;">
...
$actor_name=$_REQUEST['actor_name'];

$sql = "INSERT INTO chart(id,district_name,keywords,keywords2,keywords3,total_incidents) 
values('','','','','$actor_name',0)";
...
if($actor_name!="" AND $startdate=="" AND $enddate==""){
$sql = "INSERT INTO chart (district_name, keywords,keywords2,keywords3, label, total_incidents) 
SELECT district_name, actor_name,incident_name,dateincident, CONCAT(district_name,neighbor_country),count(actor_name) 
FROM reports WHERE actor_name='$actor_name' GROUP BY district_name, neighbor_country, actor_name";
	
}


elseif($actor_name!="" AND $startdate!="" AND $enddate!=""){
$sql = "INSERT INTO chart (district_name, keywords,keywords2,keywords3, label, total_incidents) 
SELECT district_name, actor_name,incident_name,dateincident, CONCAT(district_name,neighbor_country),
count(actor_name) FROM reports WHERE actor_name='$actor_name' 
AND (dateincident BETWEEN '$startdate' AND '$enddate') GROUP BY district_name, neighbor_country, actor_name";
                ...
                function (data)
                {
                    ...
                    var chartdata = {
                        ...
                        datasets: [
                            {
                                label: 'Records',
                                backgroundColor : ["#CD5C5C", "#556B2F", "blue", "purple", "#2F4F4F","#808000",
								"#87CEEB","#FF0000","#FFA500","#00FF7F","#7FFF00","#5F9EA0","#00FFFF","#3CB371"
								,"#00FFFF","#F0E68C","#9ACD32","#CD5C5C", "#556B2F", "blue", "purple", "magenta","#808000",
								"#87CEEB","#FF0000","#FFA500","#00FF7F","#7FFF00","#5F9EA0","#00FFFF","#3CB371"
								,"#00FFFF","#F0E68C","#9ACD32","#CD5C5C", "#556B2F", "blue", "purple", "magenta","#808000",
								"#87CEEB","#FF0000","#FFA500","#00FF7F","#7FFF00","#5F9EA0","#00FFFF","#3CB371"
								,"#00FFFF","#F0E68C","#9ACD32","#CD5C5C", "#556B2F", "blue", "purple", "magenta","#808000",
...
SELECT district_name, actor_name,incident_name,dateincident, CONCAT(district_name,neighbor_country),count(actor_name) 
FROM reports WHERE actor_name='$actor_name' 
...
$sql = 'SELECT * 
		FROM details WHERE total_incidents!=0 ORDER BY label ASC';
...
<body>
	...
	<table class="data-table">
		...
		{
			echo '<tr>
			<td>Location:&nbsp;&nbsp;'.$row['label'].'<br>Incident:&nbsp;&nbsp;'.$row['keywords2'].

...
if($incident!="" AND $startdate==!"" AND $enddate==!"" AND $actors_group_name==""){
	//COUNT FOR NYAGATARE
$displayNYAGATARE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYAGATARE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR BURERA
$displayBURERA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'BURERA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR MUSANZE
$displayMUSANZE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'MUSANZE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR GICUMBI
$displayGICUMBI ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'GICUMBI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR GATSIBO
$displayGATSIBO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'GATSIBO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR RULINDO
$displayRULINDO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'RULINDO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR GAKENKE
$displayGAKENKE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'GAKENKE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR NYABIHU
$displayNYABIHU ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYABIHU' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR RUBAVU
$displayRUBAVU ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'RUBAVU' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR KAYONZA
$displayKAYONZA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'KAYONZA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR RWAMAGANA
$displayRWAMAGANA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'RWAMAGANA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR GASABO
$displayGASABO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'GASABO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR NGORORERO
$displayNGORORERO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NGORORERO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR RUTSIRO
$displayRUTSIRO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'RUTSIRO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR KICUKIRO
$displayKICUKIRO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'KICUKIRO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
$displayNYARUGENGE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYARUGENGE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR KAMONYI
$displayKAMONYI ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'KAMONYI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR MUHANGA
$displayMUHANGA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'MUHANGA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR KARONGI
$displayKARONGI ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'KARONGI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR KIREHE
$displayKIREHE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'KIREHE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR NGOMA
$displayNGOMA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NGOMA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR BUGESERA
$displayBUGESERA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'BUGESERA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR RUHANGO
$displayRUHANGO ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'RUHANGO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR NYANZA
$displayNYANZA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYANZA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR GISAGARA
$displayGISAGARA ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'GISAGARA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
$displayNYAMASHEKE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYAMASHEKE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR NYAMAGABE
$displayNYAMAGABE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYAMAGABE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR RUSIZI
$displayRUSIZI ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'RUSIZI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR HUYE
$displayHUYE ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'HUYE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR NYARUGURU
$displayNYARUGURU ="select district_name, incident_name, count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND district_name = 'NYARUGURU' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR Uganda
$displayUganda ="select district_name, actor_name, neighbor_country,  count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND neighbor_country = 'Uganda' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR DRC
$displayDRC ="select district_name, actor_name, neighbor_country,  count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND neighbor_country = 'DRC' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR TANZANIA
$displayTANZANIA ="select district_name, actor_name, neighbor_country,  count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND neighbor_country = 'TANZANIA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
//COUNT FOR BURUNDI
$displayBURUNDI ="select district_name, actor_name, neighbor_country,  count(incident_name) AS counts FROM reports WHERE incident_name='$incident' AND neighbor_country = 'BURUNDI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
...
<?php	
	...
	{
	//COUNT FOR NYAGATARE
$displayNYAGATARE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYAGATARE'  AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYAGATARE = mysqli_query($conn, $displayNYAGATARE);
...
//COUNT FOR BURERA
$displayBURERA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'BURERA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlBURERA = mysqli_query($conn, $displayBURERA);
...
//COUNT FOR MUSANZE
$displayMUSANZE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'MUSANZE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlMUSANZE = mysqli_query($conn, $displayMUSANZE);
...
//COUNT FOR GICUMBI
$displayGICUMBI ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'GICUMBI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlGICUMBI = mysqli_query($conn, $displayGICUMBI);
...
//COUNT FOR GATSIBO
$displayGATSIBO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'GATSIBO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlGATSIBO = mysqli_query($conn, $displayGATSIBO);
...
//COUNT FOR RULINDO
$displayRULINDO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'RULINDO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlRULINDO = mysqli_query($conn, $displayRULINDO);
...
//COUNT FOR GAKENKE
$displayGAKENKE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'GAKENKE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlGAKENKE = mysqli_query($conn, $displayGAKENKE);
...
//COUNT FOR NYABIHU
$displayNYABIHU ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYABIHU' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYABIHU = mysqli_query($conn, $displayNYABIHU);
...
//COUNT FOR RUBAVU
$displayRUBAVU ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'RUBAVU' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlRUBAVU = mysqli_query($conn, $displayRUBAVU);
...
//COUNT FOR KAYONZA
$displayKAYONZA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'KAYONZA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlKAYONZA = mysqli_query($conn, $displayKAYONZA);
...
//COUNT FOR RWAMAGANA
$displayRWAMAGANA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'RWAMAGANA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlRWAMAGANA = mysqli_query($conn, $displayRWAMAGANA);
...
//COUNT FOR GASABO
$displayGASABO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'GASABO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlGASABO = mysqli_query($conn, $displayGASABO);
...
//COUNT FOR NGORORERO
$displayNGORORERO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NGORORERO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNGORORERO = mysqli_query($conn, $displayNGORORERO);
...
//COUNT FOR RUTSIRO
$displayRUTSIRO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'RUTSIRO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlRUTSIRO = mysqli_query($conn, $displayRUTSIRO);
...
//COUNT FOR KICUKIRO
$displayKICUKIRO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'KICUKIRO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlKICUKIRO = mysqli_query($conn, $displayKICUKIRO);
...
//COUNT FOR NYARUGENGE
$displayNYARUGENGE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYARUGENGE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYARUGENGE = mysqli_query($conn, $displayNYARUGENGE);
...
//COUNT FOR KAMONYI
$displayKAMONYI ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'KAMONYI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlKAMONYI = mysqli_query($conn, $displayKAMONYI);
...
//COUNT FOR MUHANGA
$displayMUHANGA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'MUHANGA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlMUHANGA = mysqli_query($conn, $displayMUHANGA);
...
//COUNT FOR KARONGI
$displayKARONGI ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'KARONGI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlKARONGI = mysqli_query($conn, $displayKARONGI);
...
//COUNT FOR KIREHE
$displayKIREHE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'KIREHE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlKIREHE = mysqli_query($conn, $displayKIREHE);
...
//COUNT FOR NGOMA
$displayNGOMA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NGOMA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNGOMA = mysqli_query($conn, $displayNGOMA);
...
//COUNT FOR BUGESERA
$displayBUGESERA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'BUGESERA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlBUGESERA = mysqli_query($conn, $displayBUGESERA);
...
//COUNT FOR RUHANGO
$displayRUHANGO ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'RUHANGO' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlRUHANGO = mysqli_query($conn, $displayRUHANGO);
...
//COUNT FOR NYANZA
$displayNYANZA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYANZA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYANZA = mysqli_query($conn, $displayNYANZA);
...
//COUNT FOR GISAGARA
$displayGISAGARA ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'GISAGARA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlGISAGARA = mysqli_query($conn, $displayGISAGARA);
...
//COUNT FOR NYAMASHEKE
$displayNYAMASHEKE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYAMASHEKE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYAMASHEKE = mysqli_query($conn, $displayNYAMASHEKE);
...
//COUNT FOR NYAMAGABE
$displayNYAMAGABE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYAMAGABE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYAMAGABE = mysqli_query($conn, $displayNYAMAGABE);
...
//COUNT FOR RUSIZI
$displayRUSIZI ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'RUSIZI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlRUSIZI = mysqli_query($conn, $displayRUSIZI);
...
//COUNT FOR HUYE
$displayHUYE ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'HUYE' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlHUYE = mysqli_query($conn, $displayHUYE);
...
//COUNT FOR NYARUGURU
$displayNYARUGURU ="select district_name, actor_name, count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND district_name = 'NYARUGURU' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlNYARUGURU = mysqli_query($conn, $displayNYARUGURU);
...
//COUNT FOR Uganda
$displayUganda ="select district_name, actor_name, neighbor_country,  count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND neighbor_country = 'Uganda' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlUganda = mysqli_query($conn, $displayUganda);
...
//COUNT FOR DRC
$displayDRC ="select district_name, actor_name, neighbor_country,  count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND neighbor_country = 'DRC' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlDRC = mysqli_query($conn, $displayDRC);
...
//COUNT FOR TANZANIA
$displayTANZANIA ="select district_name, actor_name, neighbor_country,  count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND neighbor_country = 'TANZANIA' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlTANZANIA = mysqli_query($conn, $displayTANZANIA);
...
//COUNT FOR BURUNDI
$displayBURUNDI ="select district_name, actor_name, neighbor_country,  count(actor_name) AS counts FROM reports WHERE actor_name='$actors_group_name' AND neighbor_country = 'BURUNDI' AND (dateincident BETWEEN '$startdate' AND '$enddate')";
	$sqlBURUNDI = mysqli_query($conn, $displayBURUNDI);
